...
/**
 * sqvf_dossiers_annee_controle_document_consulte_apres_annulation
 *
 * @ORM\Table(name="sqvf_dossiers_annee_controle_document_consulte_apres_annulation")
 * @ORM\Entity(repositoryClass="SQVFBundle\Repository\sqvf_dossiers_annee_controle_document_consulte_apres_annulationRepository")
 */
class sqvf_dossiers_annee_controle_document_consulte_apres_annulation
{
    /**
     * @var int
     *
     ...
     *
     * @return sqvf_dossiers_annee_controle_document_consulte_apres_annulation
     */
