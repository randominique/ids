 ...
 * @ORM\Entity(repositoryClass="DBundle\Repository\sqvfDossiersAnneeControleMontantRepository")
 */
class sqvfDossiersAnneeControleMontant
{
    /**
     * @var int
     *
     ...
     *
     * @return sqvfDossiersAnneeControleMontant
     */
