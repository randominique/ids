 ...
 * Assessement
 * 
 * @ORM\Table(name="assujettissement")
 * @ORM\Entity(repositoryClass="DBundle\Repository\AssujettissementRepository")
 */
class Assujettissement
{
    /**
     * @var int
     * 
   ...
   public $taxAccountNo;
     ...
     * Set plasTaxBalance
     *
     * @param integer $plasTaxBalance
     *
     * @return Assessment
     */
    public function setPlasTaxBalance($plasTaxBalance)
    {
        $this->plasTaxBalance = $plasTaxBalance;
     ...
     * @return integer
     */
    public function getPlasTaxBalance()
    {
        return $this->plasTaxBalance;
    }
