...
/**
 * CategorieCourierEntrant
 *
 * @ORM\Table(name="categorie_courier_entrant")
 * @ORM\Entity(repositoryClass="DBundle\Repository\CategorieCourierEntrantRepository")
 */
class CategorieCourierEntrant
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="CourierEntrant", mappedBy="categorie")
     */
    private $couriers;
     ...
     * Add courier
     *
     * @param \DBundle\Entity\CourierEntrant $courier
     *
     * @return CategorieCourierEntrant
     */
    public function addCourier(\DBundle\Entity\CourierEntrant $courier)
    {
     ...
     * @param \DBundle\Entity\CourierEntrant $courier
     */
    public function removeCourier(\DBundle\Entity\CourierEntrant $courier)
    {
